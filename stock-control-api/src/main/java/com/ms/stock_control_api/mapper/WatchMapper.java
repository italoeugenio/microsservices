...
public class WatchMapper {
    ...
    public WatchModel dtoToModel(WatchRequestDTO dto) {
        ...
        var brand = brandRepostiory.findById(dto.brandId())
        ...
        watch.setMovimentType(MovimentType.fromApi(dto.movementType()));
    ...
    private long checkColllectorScore(WatchRequestDTO watchRequestDTO){
        ...
        if (MovimentType.fromApi(watchRequestDTO.movementType()).equals(MovimentType.AUTOMATIC)) score += 20;
